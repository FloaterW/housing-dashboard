...
function RentalDashboard({ selectedRegion = 'Peel Region' }) {
  ...
  const pbrData = [
    { category: 'Existing Stock', value: rentalStockSummary2024.totalPBRUnits - rentalStockSummary2024.newPBRUnits },
    { category: 'New Units (2024)', value: rentalStockSummary2024.newPBRUnits },
  ];

  // Rented condos data for donut chart
  const condoData = [
    { name: 'Purpose-Built Rental', value: rentalStockSummary2024.totalPBRUnits },
  ...
  const renderVacancyRates = () => (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <h3 className="text-lg font-bold text-gray-800 mb-4">Vacancy Rates by Bedroom Type</h3>
      ...
      <div className="mt-4 p-4 bg-orange-50 rounded-lg">
        <p className="text-sm text-orange-800">
          <span className="font-semibold">Overall Vacancy Rate:</span> {rentalStockSummary2024.overallVacancyPct}%
        </p>
  ...
  const renderPurposeBuiltUnits = () => (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <h3 className="text-lg font-bold text-gray-800 mb-4">Purpose-Built Rental Units</h3>
      <ResponsiveContainer width="100%" height={300}>
        <AreaChart
          data={pbrData}
      ...
      <div className="mt-4 grid grid-cols-2 gap-4">
        <div className="bg-blue-50 rounded-lg p-3 text-center">
          <p className="text-2xl font-bold text-blue-600">{rentalStockSummary2024.totalPBRUnits.toLocaleString()}</p>
          <p className="text-sm text-blue-800">Total PBR Units</p>
        </div>
        <div className="bg-green-50 rounded-lg p-3 text-center">
          <p className="text-2xl font-bold text-green-600">+{rentalStockSummary2024.newPBRUnits.toLocaleString()}</p>
  ...
  const renderRentedCondos = () => (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <h3 className="text-lg font-bold text-gray-800 mb-4">Rental Stock Composition</h3>
        ...
        <div className="space-y-3">
          <div className="bg-blue-50 rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-blue-800 font-medium">Purpose-Built</span>
            ...
            <div className="w-full bg-blue-200 rounded-full h-2">
              <div 
                ...
                style={{ width: `${(rentalStockSummary2024.totalPBRUnits / (rentalStockSummary2024.totalPBRUnits + rentalStockSummary2024.rentedCondos)) * 100}%` }}
              />
            </div>
          </div>
          ...
          <div className="bg-green-50 rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-green-800 font-medium">Rented Condos</span>
            ...
            <div className="w-full bg-green-200 rounded-full h-2">
              <div 
                ...
                style={{ width: `${(rentalStockSummary2024.rentedCondos / (rentalStockSummary2024.totalPBRUnits + rentalStockSummary2024.rentedCondos)) * 100}%` }}
              />
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <p className="text-sm text-gray-700">
              ...
              <span className="ml-2 text-lg font-bold text-gray-800">
                {(rentalStockSummary2024.totalPBRUnits + rentalStockSummary2024.rentedCondos).toLocaleString()}
              </span>
            </p>
          </div>
        </div>
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">New & Total Rental</h2>
        <p className="text-gray-600">Comprehensive rental market analysis and statistics</p>
      </div>
